...
from .models import Device, DeviceUser, ProcessedAttendance, RawAttendance
...
class DeviceUserAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("User Information", {"fields": ("user_id", "name", "full_name", "device", "privilege")}),
        ("Additional Info", {"fields": ("card_no", "group_id", "password")}),
        ("Timestamps", {"fields": ("created_at", "updated_at"), "classes": ("collapse",)}),
    )
...
class ProcessedAttendanceAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ("Sync Information", {"fields": ("synced_to_crm", "sync_attempts", "last_sync_attempt")}),
        ("Timestamps", {"fields": ("created_at", "updated_at"), "classes": ("collapse",)}),
    )
