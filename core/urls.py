...
router.register(
    r"processed-attendance", ProcessedAttendanceViewSet, basename="processed-attendance"
)
...
urlpatterns = [
    ...
    path(
        "devices/<int:device_id>/users/<str:user_id>/edit/",
        device_user_edit,
        name="device_user_edit",
    ),
    path("devices/<int:device_id>/users/delete/", device_user_delete, name="device_user_delete"),
    path(
        "devices/<int:device_id>/users/delete-from-db/",
        device_user_delete_from_db,
        name="device_user_delete_from_db",
    ),
