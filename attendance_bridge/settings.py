...
LOGGING = {
    ...
    "loggers": {
        ...
        "django": {"handlers": ["console"], "level": os.getenv("LOG_LEVEL", "INFO")},
    },
}
...
OUTLIER_EMAIL_RECIPIENTS = [
    email.strip() for email in os.getenv("OUTLIER_EMAIL_RECIPIENTS", "").split(",") if email.strip()
]
